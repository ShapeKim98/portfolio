...
import { ProblemSolvingBlock, InlineDiagram } from "./Diagrams";
import {
  SectionInner,
  SectionGroup,
  ProblemSolvingList,
        ...
        <SectionInner>
          ...
          >
            ...
            <SectionGroup title="프로젝트 설계">
              ...
              <DesignGroup title="Apple Watch ↔ iPhone 통신 설계">
                <FadeInView>
                  <p className="text-base font-normal text-muted-foreground leading-relaxed mt-4 mb-6">
              ...
              {/* HealthKit 설계 */}
              <DesignGroup title="HealthKit 설계">
                <FadeInView>
                  <p className="text-base font-normal text-muted-foreground leading-relaxed mt-4 mb-4">
              ...
              {/* Clean Architecture */}
              <DesignGroup title="Clean Architecture 적용">
                <FadeInView>
                  <p className="text-base font-normal text-muted-foreground leading-relaxed mt-4 mb-4">
