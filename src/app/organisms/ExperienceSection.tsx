...
import { SectionInner, SectionPageHeading } from "../templates";
import { DotSeparator, Divider } from "../atoms";
import { ParallaxBlobLayer } from "./animation";
        ...
        <FadeInView speed={1.3}>
          <div className="mb-12">
            ...
            <div className="text-md font-normal text-muted-foreground leading-loose max-w-3xl space-y-2">
              ...
              <p>
                약 9개월간 신규 기능 개발부터 성능 최적화, CI/CD 구축, 아키텍처
              ...
              <p>
                부족한 QA 인력을 보충하기 위해 자발적으로 QA 직무에 도전했고,
                도메인 숙련도가 부족한 상황을 MCP + AI 스킬 기반 데이터 검증
                방식을 직접 고안·적용해 극복하면서 자체 검증을 중시하는 개발
                습관을 체득했습니다.
              </p>
            </div>
          </div>
